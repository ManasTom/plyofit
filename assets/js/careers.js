    ...
    vacancyRef.once("value", function (snapshot) {
        ...
        var popupContent = `
            ...
            <form id="applicationForm">
                <input type="text" id="fullName" name="fullName" placeholder="Full Name" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;"><br/>
                <input type="tel" id="contactNumber" name="contactNumber" placeholder="Contact Number" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                <input type="email" id="email" name="email" placeholder="Email ID" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                <input type="text" id="place" name="place" placeholder="Place" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;"><br/>
                ...
                <input type="text" id="workExperience" name="workExperience" placeholder="Work Experience in same field" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                <label for="certifiedTrainer" style="color: #000000;">Certified Trainer:</label>
                <select id="certifiedTrainer" name="certifiedTrainer" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                </select>
                <input type="text" id="certificationName" name="certificationName" placeholder="Certification Name/s" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                ...
                <input type="text" id="salaryExpectations" name="salaryExpectations" placeholder="Salary expectations" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
                ...
                <input type="file" id="resume" name="resume" accept="application/pdf, application/msword, application/vnd.openxmlformats-officedocument.wordprocessingml.document" style="margin-bottom: 10px; border: 1px solid #000000; border-radius: 5px; padding: 5px;">
